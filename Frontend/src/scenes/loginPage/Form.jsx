...
const Form=()=>{
    ...
    const register=async (values, onSubmitProps)=>{
        ...
        const savedUserResponse= await fetch(
            "https://mern-app-ug33.onrender.com/auth/register",
            {
                method: "POST",
                body:formData
            }
    ...
    const login= async (value, onSubmitProps)=>{
        const loggedInResponse= await fetch(
            "https://mern-app-ug33.onrender.com/auth/login",
            {
                method: "POST",
        ...
        {({
           ...
           <form onSubmit={handleSubmit}>
            ...
            <Box>
                ...
                >
                    {isLogin ? "Don't have an account ? Singn Up here. " :" Already have an account ? Login here."}
                </Typography>
            </Box>
